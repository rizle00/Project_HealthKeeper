...
2026-09-19에 원격 5개 브랜치의 과거 이력에서도 비밀 파일·하드코딩 자격증명·기기 토큰을 제거했습니다. 기존 복제본을 다시 푸시하면 이전 이력이 복구될 수 있으므로 새로 clone해서 사용하세요. GitHub의 옛 커밋 캐시나 다른 사람이 가진 사본의 삭제까지 보장하는 작업은 아닙니다.
