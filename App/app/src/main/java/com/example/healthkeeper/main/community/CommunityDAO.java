...
public class CommunityDAO {
    List<CommunityDTOS.Community_BoardDTO> getRecentBoardList() {//getBoardArrayList 중 게시글 4개만 보여주기
        List<CommunityDTOS.Community_BoardDTO> list =getBoardList();
    ...
    public List<CommunityDTOS.Community_BoardDTO> getBoardList() {
        // 전체 게시글 데이터
    ...
    public List<CommunityDTOS.Community_QuestionDTO> getQuestionArrayList() {
        //자주 묻는 질문 데이터
        List<CommunityDTOS.Community_QuestionDTO> list= new ArrayList<>();
    ...
    public List<CommunityDTOS.Community_NoticeDTO> getNoticeArrayList() {
        ...
        List<CommunityDTOS.Community_NoticeDTO> list=new ArrayList<>();
