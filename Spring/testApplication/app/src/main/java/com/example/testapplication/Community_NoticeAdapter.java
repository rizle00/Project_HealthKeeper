...
import com.example.testapplication.databinding.RecvCommunityNoticeBinding;
...
public class Community_NoticeAdapter extends RecyclerView.Adapter<Community_NoticeAdapter.ViewHolder> {
    ...
    public Community_NoticeAdapter(LayoutInflater inflater, List<CommunityDTOS.Community_QuestionDTO> list, Context context){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        holder.binding.tvCategory.setText(list.get(i).getNotice_id());
        holder.binding.tvNoticeTitle.setText(list.get(i).getTITLE());
        holder.binding.tvDate.setText(list.get(i).getTIME());
        holder.binding.tvTime.setText(list.get(i).getREAD_CNT());
